    ...
    */
    internal class LeftArmAnalysis : ArmAnalysis
    {
        ...
        public override void AngleExtraction()
        {
            ...
            float vAngularVelocityLeftElbowPronationNew = (vAngleLeftElbowPronationNew - Mathf.Abs(mAngleLeftElbowPronation)) / vTimeDifference;
            ...
            mAngleLeftElbowPronation = vAngleLeftElbowPronationNew;


            //Debug.Log ("Elbow Pronation Angles" + mAngleLeftElbowPronation + ", and, " + mAngularVelocityLeftElbowPronation + ", and, " + mAngularAccelerationLeftElbowPronation);
            ...
            //Debug.Log ("Left Shoulder Flexion Angles" + vAngleLeftShoulderFlexionNew + ", and, " + mAngularVelocityLeftShoulderFlexion + ", and, " + mAngularAccelerationLeftShoulderFlexion);
            ...
            //Debug.Log ("Left Shoulder Abduction Angles" + mAngleLeftShoulderAbduction + ", and, " + mAngularVelocityLeftShoulderAbduction + ", and, " + mAngularAccelerationLeftShoulderAbduction);
            ...
            //Debug.Log ("Shoulder Rotation Angles" + vAngleLeftShoulderRotationNew + ", and, " + mAngularVelocityLeftShoulderRotation + ", and, " + vAngularAccelerationLeftShoulderRotation);
