...
public class NodSensor : MonoBehaviour 
{
	...
	public void Reset() 
	{
        ...
        initRotation = Quaternion.identity; //mNodSensor.ringRotation;
        initRotationEuler = Vector3.zero; //mNodSensor.ringEulerRotation;
	...
	public void UpdateSensor () 
	{
        ...
        curRotation = Quaternion.identity;// mNodSensor.ringRotation;
        ...
        curRotationRawEuler = Vector3.zero;// mNodSensor.ringEulerRotation;
