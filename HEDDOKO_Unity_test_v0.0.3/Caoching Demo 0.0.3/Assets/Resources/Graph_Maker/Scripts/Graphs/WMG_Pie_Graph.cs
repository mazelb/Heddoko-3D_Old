...
//		setOriginalPropertyValues();
    ...
    public void sliceValuesChanged(bool editorChange, bool countChanged, bool oneValChanged, int index) {
		WMG_Util.listChanged (editorChange, ref sliceValues, ref _sliceValues, oneValChanged, index);
		graphC.Changed ();
	}

	public void sliceLabelsChanged(bool editorChange, bool countChanged, bool oneValChanged, int index) {
		WMG_Util.listChanged (editorChange, ref sliceLabels, ref _sliceLabels, oneValChanged, index);
		graphC.Changed ();
	}

public 	void sliceColorsChanged(bool editorChange, bool countChanged, bool oneValChanged, int index) {
	...
	public void UpdateVisuals(bool noAnim) {
