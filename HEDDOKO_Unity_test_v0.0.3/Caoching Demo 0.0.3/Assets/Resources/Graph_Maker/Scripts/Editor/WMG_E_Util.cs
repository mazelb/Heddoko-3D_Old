...
//	}
	...
	public void ExposeProperty(WMG_PropertyField field, string tooltip = "")
	{
		...
		if (field.Type == SerializedPropertyType.Integer)
		{
			...
			var newValue = EditorGUILayout.IntField(new GUIContent(field.Name, tooltip), oldValue, emptyOptions);
			if (oldValue != newValue)
				field.SetValue(newValue);
		}
		else if (field.Type == SerializedPropertyType.Float)
		{
			...
			var newValue = EditorGUILayout.FloatField(new GUIContent(field.Name, tooltip), oldValue, emptyOptions);
			if (oldValue != newValue)
				field.SetValue(newValue);
		}
		else if (field.Type == SerializedPropertyType.Boolean)
		{
			...
			var newValue = EditorGUILayout.Toggle(new GUIContent(field.Name, tooltip), oldValue, emptyOptions);
			if (oldValue != newValue)
				field.SetValue(newValue);
		}
		else if (field.Type == SerializedPropertyType.String)
		{
			...
			var newValue = EditorGUILayout.TextField(new GUIContent(field.Name, tooltip), oldValue, emptyOptions);
			if (oldValue != newValue)
				field.SetValue(newValue);
		}
		else if (field.Type == SerializedPropertyType.Vector2)
		{
			...
			var newValue = EditorGUILayout.Vector2Field(new GUIContent(field.Name, tooltip), oldValue, emptyOptions);
			if (oldValue != newValue)
				field.SetValue(newValue);
		}
		else if (field.Type == SerializedPropertyType.Vector3)
		{
			...
			var newValue = EditorGUILayout.Vector3Field(new GUIContent(field.Name, tooltip), oldValue, emptyOptions);
			if (oldValue != newValue)
				field.SetValue(newValue);
		}
		else if (field.Type == SerializedPropertyType.Enum)
		{
			...
			var newValue = EditorGUILayout.EnumPopup(new GUIContent(field.Name, tooltip), oldValue, emptyOptions);
			if (oldValue != newValue)
				field.SetValue(newValue);
		}
		else if (field.Type == SerializedPropertyType.Color)
		{
			...
			var newValue = EditorGUILayout.ColorField(new GUIContent(field.Name, tooltip), oldValue, emptyOptions);
			if (oldValue != newValue)
				field.SetValue(newValue);
		}
	}
