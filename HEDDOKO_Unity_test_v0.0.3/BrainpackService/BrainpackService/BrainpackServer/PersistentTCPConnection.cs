...
/** 
* @file PersistentTCPConnection.cs
* @brief Contains the PersistentTCPConnection class
...
{
    /// <summary>
    /// PersistentTCPConnection to handle multiple connection stream requests, with persistent connection
    /// </summary>
    public class PersistentTCPConnection: IBrainpackServer
    {
